...
void setHTML(byte page)
{
	...
	webString += "<style>\n";
	webString += "body{background-color: #5f5f5f;font-family:\"Segoe UI\",Tahoma,sans-serif;color:#f1f1f1;font-weight: normal;}\n";
...
#endif
	webString += "<br />Current Firmware Version: V" + String(VERSION) + "\n<br/>";
